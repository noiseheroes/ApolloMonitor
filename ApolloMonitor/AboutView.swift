...
struct AboutView: View {
    ...
    private var description: some View {
        VStack(spacing: 8) {
            Text("Native macOS menu bar app for controlling Universal Audio Apollo Solo monitor volume.")
                .font(.system(size: 12))
                .foregroundStyle(.secondary)
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                creditRow(
                    ...
                    detail: "cuefinger by @tschiemer",
                    url: "https://github.com/tschiemer/cuefinger"
                )
